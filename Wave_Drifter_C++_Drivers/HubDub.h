...
thereturn_t accel_ODRset(uint8_t*);

thereturn_t gyro_ODRset(uint8_t*);

thereturn_t accel_scaleset(uint8_t*);

thereturn_t gyro_scaleset(uint8_t*);

thereturn_t accel_dis(void);
...
thereturn_t func_cfg_en(uint8_t*);

thereturn_t func_cfg_dis(void);

thereturn_t slv_0add(uint8_t addr, int rw_0);

thereturn_t slv_0subadd(uint8_t addr);

thereturn_t i2c_mast_en(uint8_t*);

thereturn_t slv_wrt(uint8_t);

thereturn_t slv_0conf(uint8_t*);

thereturn_t hub_mast_en(void);

thereturn_t hub_mast_dis(void);
...
thereturn_t fifodefault(uint8_t*);

thereturn_t magfifoconfig(uint8_t*);

thereturn_t fifo_conf(uint8_t*);

uint8_t fifo_getstatus(void);

thereturn_t fifo_clear(void);

thereturn_t fifo_watermark(uint8_t*, uint16_t threshold);

thereturn_t fifo_mode(uint8_t*);

thereturn_t fifo_odr(uint8_t*);

thereturn_t fifodec_accel(uint8_t*);

thereturn_t fifodec_gyro(uint8_t*);

thereturn_t fifodec_mag(uint8_t*);

uint8_t fifo_wtrm_flag(void);

uint16_t fifo_read(void);

thereturn_t fifo_set(uint8_t*);
